...
{
	[CreateAssetMenu(fileName = "QRCodeTrackingServiceProfile", menuName = "RealityCollective/QRCodeTrackingService Profile")]
	public class QRCodeTrackingServiceProfile : BaseServiceProfile<IServiceModule>
	{
        [SerializeField] 
