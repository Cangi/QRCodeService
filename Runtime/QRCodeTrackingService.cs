...
using MRTKExtensions.QRCodes.Utilities;
using RealityCollective.ServiceFramework.Services;
using UnityEngine;

namespace MRTKExtensions.QRCodes
{
    [System.Runtime.InteropServices.Guid("e55c75db-0a3d-4b85-b781-9be91fe69f49")]
    public class QRCodeTrackingService : BaseServiceWithConstructor, IQRCodeTrackingService
    {
        ...
        public QRCodeTrackingService(string name, uint priority, QRCodeTrackingServiceProfile profile) : base(name, priority)
        {
